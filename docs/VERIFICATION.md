...
| Restart launch dry run | `npm run restart-ulanzi:launch-dry-run` | Passed; launched the PowerShell helper through WMI with `-DryRun` and reported the created helper process without stopping Ulanzi |
