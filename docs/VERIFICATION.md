...
| Restart launch dry run | `npm run restart-ulanzi:launch-dry-run` | Passed; launched the PowerShell helper from Node with `-DryRun` and reported Ulanzi-owned processes without stopping them |
