...
Static backgrounds should be 144x144 SVGs without text. Transition GIFs should be 144x144 full-background animations for entering a band. Missing static assets fall back to generated band colors, and missing GIFs simply skip the transition.
